...
import com.crm.po.Sjzdxx;

/**
 	* A data access object (DAO) providing persistence and search support for Sjzdxx entities.
 			* Transaction control of the save(), update() and delete() operations 
		can directly support Spring container-managed transactions or they can be augmented	to handle user-managed Spring transactions. 
		Each of these methods provides additional information for how to configure it for the desired type of transaction control. 	
	 * @see com.crm.po.Sjzdxx
  * @author MyEclipse Persistence Tools 
 */
public class SjzdxxDAO extends HibernateDaoSupport  {
    ...
    public Sjzdxx findById( java.lang.Integer id) {
        ...
        try {
            Sjzdxx instance = (Sjzdxx) getSession()
                    .get("com.crm.po.Sjzdxx", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public List findByExample(Sjzdxx instance) {
        ...
        try {
            List results = getSession()
                    .createCriteria("com.crm.po.Sjzdxx")
